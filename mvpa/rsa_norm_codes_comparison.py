...
save = True
save_prefix = 'rsa_range_norm_divisive'
...
for subj in subj_list:
    ...
    for model_num,params in enumerate(params_sweep):
        ...
        if model == 'Divisive':
            ...
            norm_values[sitem_inds] = compute_range_norm(abs_value[sitem_inds], beta, sigma) 
            norm_values[bundle_inds] = compute_range_norm(abs_value[bundle_inds], beta, sigma) 
            num_params = 2
