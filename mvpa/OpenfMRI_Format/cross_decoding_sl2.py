...
for subj in subj_list:
    ...
    presave_file = bundle_path+'mvpa/presaved_data/sub'+str(subj)+'/fds_list_all_cat_rel_value'
    #fds = mvpa_utils.make_targets(subj, glm_ds_file, brain_mask, conditions, presave_file, relative_value=relative_value, tolman=False)
    fds_x, fds_y, fds_chunks, fds_trial_categ, fds_vox_inds = mvpa_utils.make_targets(subj, glm_ds_file, 
                                                            brain_mask, conditions, presave_file, relative_value=relative_value, tolman=False)
    #zscore targets
