# -*- coding: utf-8 -*-
"""
Created on Fri Feb  7 11:17:02 2025
...
for subj in subj_list:
    ...
    if remove_within_day:
        ...
        if ranked:
            ...
            # temp 
            btwn_day_inds2 = np.where(target_dsms['item_or_bundle'] == 1)[0]
            btwn_day_inds = np.intersect1d(btwn_day_inds, btwn_day_inds2)
