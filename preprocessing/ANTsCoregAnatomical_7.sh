...
subAnatDir=/home/lcross/Bundle_Value/preprocessing/prepForICA/sub${sbj}/
standardAnatDir=/home/lcross/Atari/FSL_Code_BetICA/preprocessing/

# align the T1 and T2 anatomicals and downsample to funcitonal resolution
