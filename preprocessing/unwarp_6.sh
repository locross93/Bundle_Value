...
funcDir=/home/lcross/Bundle_Value/preprocessing/FSL_ICA_BET/sub${subjectID}/Session${runID}.ica/
...
fugue -i ${funcScan} --dwell=${dwellTime} --loadfmap=${mapImage}_EPIalign --unwarpdir=y -u ${funcScan}_unwarped_new

# extract a single volume for warped/unwarped comparison to the original T2
fslroi ${funcScan} ${funcScan}_sample 0 1
fslroi ${funcScan}_unwarped_new ${funcScan}_unwarped_sample 0 1
