...
sessionScript=/home/lcross/Bundle_Value/code/preprocessing/applyANTsToFunc_unclean_8.sh

for subj in 110-1 110-2 110-3 111-1 111-2 111-3 113-1 113-2 113-3 114-1 114-2 114-3
do
