...
input_dir=/home/lcross/Bundle_Value/preprocessing/FSL_ICA_BET/sub${subjectID}/Session${sessionID}.ica/unclean/
# Set output directory for preprocessed files
output_dir=/home/lcross/Bundle_Value/preprocessing/FSL_ICA_BET/sub${subjectID}/Session${sessionID}.ica/unclean/
analysis_dir1=/home/lcross/Bundle_Value/analysis/sub${subjectID:0:3}/
analysis_dir2=${analysis_dir1}day${subjectID:4:5}/unclean/
...
fslmaths ${input_dir}filtered_func_data_unclean_unwarped_ANTsReg -thr 1000 -bin ${input_dir}filtered_func_data_unclean_unwarped_ANTsReg_masked
fslmaths ${input_dir}filtered_func_data_unclean_unwarped_ANTsReg -s 2.12 -mas ${input_dir}filtered_func_data_unclean_unwarped_ANTsReg_masked ${output_dir}filtered_func_data_full_pipeline
#create a sample to check BET quickly on computer
mkdir $sample_dir
fslroi ${output_dir}filtered_func_data_full_pipeline ${sample_dir}sub${subjectID}_run${sessionID}_sample_smooth_unclean 0 1
