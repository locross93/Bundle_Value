...
for sub in 112
    ...
    for part in 1 2 3 4 5
    	...
    	qsub -q all.q -w e -N $job_name -l h_vmem=10G -l mem_free=10G -pe smp 1 -o ${output_dir} -e ${output_dir} -v part=$part,num_parts=$num_parts,sub=$sub, $sessionScript
    done
done