...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb  4 17:13:53 2021
...
for subj in subj_list:
    ind_item_file = '/Users/logancross/Documents/Bundle_Value/mvpa/analyses/sub'+str(subj)+'/ridge_sl_ind_item'
    bundle_file = '/Users/logancross/Documents/Bundle_Value/mvpa/analyses/sub'+str(subj)+'/ridge_sl_bundle'
    #ind_item_file = '/Users/logancross/Documents/Bundle_Value/mvpa/analyses/sub'+str(subj)+'/rsa_ind_item_value_itrials'
    #bundle_file = '/Users/logancross/Documents/Bundle_Value/mvpa/analyses/sub'+str(subj)+'/rsa_bundle_value_btrials'
    ivalue_scores = h5load(ind_item_file)
    ivalue_scores = ivalue_scores.reshape(-1)
    bvalue_scores = h5load(bundle_file)
    bvalue_scores = bvalue_scores.reshape(-1)
    
    #normalize
    ivalue_scores = scipy.stats.zscore(ivalue_scores)
    bvalue_scores = scipy.stats.zscore(bvalue_scores)
    ...
    bundle_pref = bvalue_scores[mask_inds] - ivalue_scores[mask_inds]
