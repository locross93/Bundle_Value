# -*- coding: utf-8 -*-
"""
Created on Mon May 17 15:36:32 2021
...
analysis_name = 'rsa_abs_rel_bin_btwnday'
...
for subj in subj_list[1:]:
    temp_df = pd.read_csv(bundle_path+'mvpa/analyses/sub'+str(subj)+'/rsa_abs_rel_bin_btwnday.csv')
...
plt.title('RSA Absolute vs. Relative Value')
